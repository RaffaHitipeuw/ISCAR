  ...
  import { AlignCenter, AlignEndVertical, AlignEndVerticalIcon } from "lucide-react";
    ...
    export default function IntroUI() {
      ...
      return (
          ...
          <div className="lg:hidden absolute inset-0 pointer-events-none">
            ...
            <div
              className="absolute bottom-10 left-32 -translate-x-1/2
                        w-[60%] text-left text-sm text-white leading-relaxed"
              style={{ fontFamily: interTight }}
            >
              “Official representative body of Abu Dzar students.
              We bridge ideas, foster innovation, and create a home
          ...
          <div className="hidden lg:flex fixed inset-0 flex-col justify-between py-10">
            <div className="w-full">
              ...
              >
                ...
                <div className="text-center">
                  <BlurText text="GALLERY" delay={500} />
                </div>
                <div className="text-right">
                  <BlurText text="MAIN EVENT" delay={600} />
                </div>
              </nav>
            </div>
            ...
            <div className="grid grid-cols-3 items-end lg:px-28 lg:pb-10">
              ...
              <div className="flex justify-center">
                ...
                <button
                  ...
                  onMouseEnter={() => { if (!isExplored) setHoverZoom(true) }}
                  onMouseLeave={() => { if (!isExplored) setHoverZoom(false) }}
                  className="
                    relative
