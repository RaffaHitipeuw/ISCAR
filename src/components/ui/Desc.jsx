...
export default function Desc() {
  ...
  const DIVISI_DATA = [
    {
      tugas:
        "Bertanggung jawab atas koordinasi, perencanaan, dan pengawasan seluruh kegiatan ISCAR agar berjalan dengan baik dan terarah.",
      members: [
    ...
    {
      tugas:
        "Menjaga kesehatan santri dan kebersihan lingkungan pesantren serta menangani pertolongan pertama pada gangguan kesehatan.",
      members: [
    ...
    {
      tugas:
        "Mengelola kegiatan fisik dan olahraga santri untuk menjaga kebugaran jasmani dan sportivitas.",
      members: [
    ...
    {
      tugas:
        "Mengembangkan kemampuan berbahasa Arab siswa melalui kegiatan edukatif, pembiasaan, dan program pendukung",
      members: [
    ...
    {
      tugas:
        "Mengembangkan minat dan bakat siswa di bidang olahraga serta menanamkan nilai sportivitas dan kerja sama.",
      members: [
        { role: "Mentor", name: "Ust. Farhan Abdillah" },
    ...
    {
      tugas:
        "Berfokus pada edukasi dan kepedulian terhadap kesehatan siswa serta mendukung terciptanya gaya hidup sehat di lingkungan sekolah.",
      members: [
    ...
    {
      tugas:
        "Mendorong terciptanya lingkungan sekolah yang bersih, nyaman, dan sehat melalui program kebersihan rutin.",
      members: [
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div
          className={`absolute ${currentData.bottomPos || "bottom-[10vh]"} right-[5vw] w-[35vw] flex flex-col gap-6 pointer-events-auto transition-all duration-500`}
        >
          <motion.div
          ...
          >
            <div
              className={`flex flex-col justify-around h-[45vh] overflow-y-auto pr-2 custom-scrollbar`}
            >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          className="absolute bottom-20 left-20 w-18 h-18 cursor-pointer rounded-full bg-white/10 backdrop-blur-xl border border-white/20 text-white flex items-center justify-center shadow-xl pointer-events-auto"
        >
          <svg
            width="24"
            height="24"
          ...
          >
            <path
              d="M1.24913 12.5L7.35413 18.647L6.64412 19.352L0.467125 13.132C-0.155875 12.508 -0.155875 11.492 0.468125 10.867L6.64412 4.647L7.35413 5.352L1.24913 11.5H16.9991V12.5H1.24913ZM11.9991 0V1C18.0641 1 22.9991 5.935 22.9991 12C22.9991 18.065 18.0641 23 11.9991 23V24C18.6161 24 23.9991 18.617 23.9991 12C23.9991 5.383 18.6161 0 11.9991 0Z"
              fill="white"
            />
          </svg>
        </motion.button>
